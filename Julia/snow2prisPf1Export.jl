...
opts_br = ContinuationPar(dsmin = 0.0001, dsmax = 0.01, ds = 0.001, 
# parameter interval
...
CSV.write("./csv/snow2prisPf1Export_br.csv",  Tables.table([br.tauC br.X br.Y br.Z e1 e2 e3 lambda_bar]), writeheader=false)
...
lamplot = plot(br1.tauC, lambda_bar, ylims=(-0.0, 1.5))
savefig(lamplot,"./plots/Snow_pris_pitch_reg_lam_br2.png")


CSV.write("./csv/snow2prisPf1Export_br1.csv",  Tables.table([br1.tauC br1.X br1.Y br1.Z e1 e2 e3 lambda_bar]), writeheader=false)
