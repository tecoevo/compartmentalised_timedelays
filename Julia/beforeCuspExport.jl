...
CSV.write("./csv/beforeCuspUp_br_eig_lam.csv",  Tables.table([br.tauC br.X br.Y br.Z e1 e2 e3 lambda_bar]), writeheader=false)
...
CSV.write("./csv/beforeCuspUp_br1_eig_lam.csv",  Tables.table([br1.tauC br1.X br1.Y br1.Z e1 e2 e3 lambda_bar]), writeheader=false)
...
CSV.write("./csv/beforeCuspLow_br_eig_lam.csv",  Tables.table([br.tauC br.X br.Y br.Z e1 e2 e3 lambda_bar]), writeheader=false)
...
CSV.write("./csv/beforeCuspLow_br1_eig_lam.csv",  Tables.table([br1.tauC br1.X br1.Y br1.Z e1 e2 e3 lambda_bar]), writeheader=false)
