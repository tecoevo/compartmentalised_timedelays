...
CSV.write("./csv/snow2prisTr2Export_br.csv",  Tables.table([br.tauC br.X br.Y br.Z e1 e2 e3 lambda_bar]), writeheader=false)
...
#CSV.write("./csv/Snow_pris_pitch_br1_eig_trans.csv",  Tables.table([br1.tauC br1.X br1.Y br1.Z e1 e2 e3]), writeheader=false)
CSV.write("./csv/snow2prisTr2Export_br1.csv",  Tables.table([br1.tauC br1.X br1.Y br1.Z e1 e2 e3 lambda_bar]), writeheader=false)
